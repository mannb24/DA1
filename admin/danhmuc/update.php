                    ...
                    <div class="row frmcontent">
                        <form action="index.php?act=updatedm" method="post">
                            <div class="row mb10">Mã loại <br>
                                <input type="text" name="maloai" disabled placeholder=<?php echo "$IDDanhMuc"; ?>>
                            </div>
                            <div class="row mb10">Tên loại <br>
                                <input type="text" name="tenloai" value="<?php if (isset($TenDanhMuc) && ($TenDanhMuc != ""))
                                    echo $TenDanhMuc; ?>">
                            </div>
                            <div class="row mb10">
                                <input type="hidden" name="id" value="<?php if (isset($IDDanhMuc) && ($IDDanhMuc > 0))
                                    echo $IDDanhMuc; ?>">
