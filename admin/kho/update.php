            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h3 class="page-title">Cập nhật loại biến thể</h3>
                    </div>
                    ...
                    <div class="row frmcontent">
                        <form action="index.php?act=updatedm" method="post">
                            ...
                            <div class="row mb10">Tên loại <br>
                                <input type="text" name="tenkho" value="<?php if (isset($TenLoai) && ($TenLoai != ""))
                                    echo $TenLoai; ?>">
                            </div>
                            <div class="row mb10">
                                <input type="hidden" name="id" value="<?php if (isset($IDKho) && ($IDKho > 0))
                                    echo $IDKho; ?>">
